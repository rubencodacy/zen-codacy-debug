...
class WalletMergeToAddressTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        wait_and_assert_operationid_status(self.nodes[0], result['opid'], timeout=600)
        self.sync_all()
        ...
        wait_and_assert_operationid_status(self.nodes[0], result, timeout=600)
        self.sync_all()
        self.nodes[1].generate(1)
        self.sync_all()
        ...
        wait_and_assert_operationid_status(self.nodes[2], result['opid'], timeout=600)
        self.sync_all()
        self.nodes[1].generate(1)
        self.sync_all()
        ...
        wait_and_assert_operationid_status(self.nodes[0], opid1, timeout=600)
        wait_and_assert_operationid_status(self.nodes[0], opid2, timeout=600)
        ...
        wait_and_assert_operationid_status(self.nodes[0], result1['opid'], timeout=600)
        wait_and_assert_operationid_status(self.nodes[0], result2['opid'], timeout=600)
